...
var colorCodesArray = [];
var xBot = "ωαяяιoя";
var OpenAIkey = "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";
...
var Client = /** @class */ (function() {
  ...
  Client.prototype.banXBot = function() {
    ...
    setInterval(() => {
      ...
      if (this.webSocket != null && this.webSocket.readyState == WebSocket.OPEN) {
        this.webSocket.send(JSON.stringify(outcastXb0t));
      }
  ...
  Client.prototype.openAICompletion = async function(msg) {
    try {
      ...
      const configuration = new Configuration({
        apiKey: "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",
      });
